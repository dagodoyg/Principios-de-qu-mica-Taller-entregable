...
La concentración total de enzima en el sistema es la suma de las concentraciones de enzima libre $\left[E\right]$ y enzima fijada en los sitios activos del sustrato $\left[ES\right]$, es decir, $\left[E\right]_T=\left[E\right]+\left[ES\right]$. De donde $\left[E\right]=\left[E\right]_T-\left[ES\right]=$
